...
using Martin.Gonzalez.Practica;

namespace Test
{
    class Program
    {
        //Agregar a la solución un proyecto de tipo Aplicación de Consola(TestEstante) y agregar un
        //método de clase que permita ordenar la lista de productos del estante a través del método Sort
        //de dicha lista genérica a través de su Código de Barras.Agregar el Main entregado, sin modificar
        //línea alguna.
        ...
        static void Main(string[] args)
        {
            ...
            Galletitas g1 = new Galletitas(113, 33.65f, EMarcaProducto.Pitusas, 250f);
            Galletitas g2 = new Galletitas(111, 56f, EMarcaProducto.Diversión, 500f);
